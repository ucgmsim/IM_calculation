...
# Stanford University                                                                                        #
# Last edited: 09-Oct-2014                                                                                   #
##############################################################################################################

# Run an eigenvalue analysis on one RC moment frame model.
# Write the mode shapes, periods, and node and element information to their respective text files.

##############################################################################################################

# Define the model directory
set modeldir Models/ID1021_20Story
...
# fullGenLapack for all except ID1021_20Story
# use $num_dof for all except ID1021_20Story which is ($num_dof-1)  
