...
# Run an incremental dynamic analysis using multiple cores.
...
set indirlist "FEMA_P695_Far_Field FEMA_P695_Far_Field_Long"

# Define the output path
set outpath Analysis_Results/IDA
...
if {$this_procid == 0} {
    ...
    # for scaling)
    set periods_file [open Model_Info/periods.out r]
